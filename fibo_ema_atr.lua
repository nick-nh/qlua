...
function FiboEMA()
	...
	return function(ind, _p, _b)
		...
		--ATR = ATR_MA(index, bars, cache_ATR, nil)
		
		cache_EMA[index]=k*C(index)+(1-k)*cache_EMA[index-1]
		
	
		inc = cache_ATR[index] or 0
		return cache_EMA[index], cache_EMA[index]+inc*4.236, cache_EMA[index]+inc*2.618, cache_EMA[index]+inc*1.618, cache_EMA[index]+inc*1, cache_EMA[index]-inc*1, cache_EMA[index]-inc*1.618, cache_EMA[index]-inc*2.618, cache_EMA[index]-inc*4.236
