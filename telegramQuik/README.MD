...
## Update 2026.01.04
Поддержка MessageThreadId в JSON формате (Сообщение в тему чата, группы).
Ссылка на собранные библиотеки с Telegram.Bot to v22.4.4 и поддержкой JSON обмена https://disk.360.yandex.ru/d/aJiqcbPWpRuMUw
