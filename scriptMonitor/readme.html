...
Есть таблица со списком инструментов, выодимые значения алгоритмов, интрументы для выставления заявок.
...
Бумаги из файла настроек. Далее последняя цена, % изменения с открытия, % изменения за неделю (на самом деле -5 дней), цена открытия, дельта от открытия, дневной ATR, размер и средняя позиции (то, что куплено)
...
<a href="http://funkyimg.com/view/2Ct3D" target="_blank"><img src="http://funkyimg.com/i/2Ct34.png" alt="Free Image Hosting at FunkyIMG.com" border="0"></a>
