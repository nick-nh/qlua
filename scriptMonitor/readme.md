...
Далее надо создать еще две папки. <b Папки не в каталоге Luaindicators, а каталоге самого Квика</b>.Мне так удобней отлаживать разные скрипты. Если угодно, меняйте в скрипте пути.
